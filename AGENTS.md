...
After bridge changes, **hard-refresh the preview** (toolbar refresh) so proxied HTML picks up the new `section-bridge?v=` version (currently v29 — progressive drag thumbnails, early capture, hover affordance, retina element previews).
