...
After bridge changes, **hard-refresh the preview** (toolbar refresh) so proxied HTML picks up the new `section-bridge?v=` version (currently v26 — hero/contact value rows including placeholder phone text are draggable).
