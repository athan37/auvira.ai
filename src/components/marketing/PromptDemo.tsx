...
export function PromptDemo() {
  ...
  return (
    <div className="rounded-2xl border border-[#d2d2d7]/60 bg-white/80 p-5 shadow-glass backdrop-blur-sm">
      ...
      <div className="mt-4 min-h-[5rem] rounded-xl bg-[#f5f5f7] px-4 py-3">
        <p className="text-[15px] leading-relaxed text-[#1d1d1f]">
          &ldquo;{visible}
          <span className="ml-0.5 inline-block h-[1.1em] w-0.5 animate-pulse bg-brand-600 align-middle" />
          &rdquo;
        </p>
      </div>
    </div>
