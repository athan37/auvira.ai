import { executeTool } from '@/lib/project-workspace/edit-shared/toolRegistry';
import { getProfileForMode } from '@/lib/project-workspace/edit-shared/profiles';
import type { ToolContext } from '@/lib/project-workspace/edit-shared/types';
...
export async function runRestrictedCustomCodeEdit(
  ...
  const profile = getProfileForMode('gitlab');
