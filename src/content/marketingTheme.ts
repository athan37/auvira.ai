/** Shared rose accent class names for landing marketing components. */
...
export const ROSE = {
  ...
  atmosphereHero: 'bg-rose-atmosphere opacity-[0.35]',
  atmosphereFinal: 'bg-rose-atmosphere opacity-20',
  text: 'text-rose-700',
